...
def _seed_courses(db):
    ...
    courses_data = [
        ...
        {"course_id": "CSE1001", "name": "이산수학", "professor": "정수민", "credits": 3,
         "type": "major_required", "department": "컴퓨터학부", "target_grade": 1,
        ...
        {"course_id": "CSE2001", "name": "알고리즘", "professor": "정하준", "credits": 3,
         "type": "major_required", "department": "컴퓨터학부", "target_grade": 2,
         "schedules": [("tue", 2, 3, "it-201"), ("thu", 2, 3, "it-201")]},
        ...
        {"course_id": "CSE3001", "name": "선형대수학", "professor": "박서연", "credits": 3,
         "type": "major_required", "department": "컴퓨터학부", "target_grade": 3,
        ...
        {"course_id": "CSE4001", "name": "캡스톤디자인", "professor": "김태훈", "credits": 3,
         "type": "major_required", "department": "컴퓨터학부", "target_grade": 4,
         "schedules": [("mon", 6, 8, "it-302")]},
        # --- 전공선택 ---
        {"course_id": "CSE3005", "name": "인공지능개론", "professor": "강도현", "credits": 3,
         "type": "major_elective", "department": "컴퓨터학부", "target_grade": 3,
    ...
    for cd in courses_data:
        ...
        course = Course(
            ...
            subject_code=cd["course_id"],
            division=1,
            name=cd["name"],
            professor=cd["professor"],
            credits=cd["credits"],
            course_type=cd["type"],
            target_grade=cd.get("target_grade"),
            offering_dept=dept or "교양대학",
            belong_dept=dept,
            semester=SEMESTER,
            max_enrollment=60,
            grade_limits=None,
        ...
        db.add(course)
        db.flush()
        for day, sp, ep, room_id in cd["schedules"]:
